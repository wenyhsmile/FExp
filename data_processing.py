...
def load_dataset(dataset_dir, dataset_name, val_ratio, test_ratio):
    ...
    elif 'ohgbn-imdbsyn' in dataset_name:
        src_ntype, tgt_ntype = 'director', 'actor'
    elif 'rpddsyn' in dataset_name:
        src_ntype, tgt_ntype = 'a', 'f'
    elif 'HGBn-ACMsyn' in dataset_name:
        src_ntype ,tgt_ntype= 'author', 'subject'             
    elif 'ohgbn-acmsyn' in dataset_name:
        src_ntype, tgt_ntype = 'author', 'paper'
    elif 'HGBn-IMDBsyn' in dataset_name:
        src_ntype, tgt_ntype = 'director', 'actor'        
    elif 'HGBn-DBLPsyn' in dataset_name:
        src_ntype,tgt_ntype = 'author', 'term'    
    elif 'ogbn-mag6syn' in dataset_name:
        src_ntype , tgt_ntype= 'author', 'institution'    
