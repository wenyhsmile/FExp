...
class PaGELink(nn.Module):
    ...
    def path_loss(self, src_nid, tgt_nid, g, eweights, pred,communities=None,community_strengths=None,num_paths=5):
        ...
        if eids_off_path_mask.any():
            ...
            loss_off_path = 0
        loss_differ = max(0,loss_off_path+0.1+loss_on_path)
    ...
    def get_edge_mask(self, 
        ...
        for e in range(self.num_epochs):    
            ...
            score_mask = shifted_sigmoid( score_mask,1)
            
           
            score_random_mask = self.model(src_nid, tgt_nid, ml_ghetero, feat_nids, ml_eweight_dict_random)
            score_random_mask =shifted_sigmoid( score_random_mask,1)
