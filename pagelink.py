...
from utils import set_seed, print_args, set_config_args,louvain_partition,get_hetero_node_community_info
...
processed_g = load_dataset(args.dataset_dir, args.dataset_name, args.valid_ratio, args.test_ratio,0)[1]
...
membership,community_strengths, node_community_strengths  = get_hetero_node_community_info(mp_g)
